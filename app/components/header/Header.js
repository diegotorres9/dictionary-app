...
export default function Header ({fontChange}) {
    ...
    <header className='grid grid-cols-header-grid items-center mb-6 lg:mb-[51.5px]'>
        ...
        <div className="theme-switch-container justify-self-end flex justify-self-center">
            ...
            />
            <span className="w-[40px] h-[20px] flex items-center flex-shrink-0 ml-4 p-1 bg-dark-gray rounded-full duration-300 ease-in-out peer-checked:bg-violet after:w-4 after:h-4 after:bg-white after:rounded-full after:shadow-md after:duration-300 peer-checked:after:translate-x-4"></span>
            </label>
